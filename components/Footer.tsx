...
const Footer = () => {
  ...
  return (
    <footer className='py-16 bg-white text-center border-t border-gold/20'>
      ...
      <p className='text-gold/60 font-serif text-xs tracking-widest uppercase'>Eternal Promise</p>
      <p className='text-gray-300 text-[10px] mt-2 font-serif'>Designed with Love</p>
    </footer>
  );
};

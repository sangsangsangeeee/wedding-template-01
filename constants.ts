...
export const TRANSPORT_DATA: TransportInfo[] = [
  {
    type: 'subway',
    title: '지하철',
    details: ['1호선 대방역 하차', '3번 출구 좌측 골목 50m 위치'],
  },
  {
    type: 'bus',
    title: '버스',
    details: ['마을버스: 동작01, 동작05, 동작05-1, 동작08, 동작12, 영등포07, 영등포 10, 영등포 11', '지선: 5531, 5634, 5623, 5633, 6211, 6411', '간선: 150, 163, 360, 361, 461, 505'],
  },
  {
    type: 'car',
    title: '자가용',
